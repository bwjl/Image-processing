...
public class ImageWaterMarkUtil {
    ...
    public static void setImageMarkOptions(float alpha, int positionWidth,
        ...
        if (alpha != 0.0f)
            ImageWaterMarkUtil.alpha = alpha;
        if (positionWidth != 0)
            ImageWaterMarkUtil.positionWidth = positionWidth;
        if (positionHeight != 0)
            ImageWaterMarkUtil.positionHeight = positionHeight;
        if (font != null)
            ImageWaterMarkUtil.font = font;
        if (color != null)
            ImageWaterMarkUtil.color = color;
    }
